...
const Footer = () => {
  ...
  <h2 className='foot-hp' data-text='Office'>Office</h2>
        ...
        <h6 className='footer-email-id footer-contacts fw-bold pb-1'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
