...
<section className="py-2 text-center container">
    ...
    <div className="memb col-lg-4 py-3">
        <img className="rounded-circle img-fluid " src="./image/Team/Fahad.jpeg" alt="DMA team member" />
      ...
      <div className="memb col-lg-4 py-3">
        <img className="rounded-circle img-fluid " src="./image/Team/Hassan.jpeg" alt="DMA team member" />
      ...
      <div className="memb col-lg-4 py-3">
        <img className="rounded-circle img-fluid " src="./image/Team/GM Baloch.jpeg" alt="DMA team member" />
      ...
      <div className="memb col-lg-4 py-3">
        <img className="rounded-circle img-fluid " src="./image/Team/Umair.jpeg" alt="DMA team member" />
      ...
      <div className="memb col-lg-4 py-3">
        <img className="rounded-circle img-fluid " src="./image/Team/Hamayon.jpg" alt="DMA team member" />
      ...
      <div className="memb col-lg-4 py-3">
        <img className="rounded-circle img-fluid " src="./image/Team/Zaman.jpg" alt="DMA team member" />
      ...
      <div className="memb col-lg-4 py-3">
        <img className="rounded-circle img-fluid " src="./image/Team/Hamza.jpeg" alt="DMA team member" />
      ...
      <div className="memb col-lg-4 py-3">
        <img className="rounded-circle img-fluid " src="./image/Team/Waheed.jpeg" alt="DMA team member" />
      ...
      <div className="memb col-lg-4 py-3">
        <img className="rounded-circle img-fluid " src="./image/Team/Bilal.jpg" alt="DMA team member" />
      ...
      <div className="memb col-lg-4 py-3">
        <img className="rounded-circle img-fluid " src="./image/Team/Farhan.jpeg" alt="DMA team member" />
      ...
      <div className="memb col-lg-4 py-3">
        <img className="rounded-circle img-fluid " src="./image/Team/Imran.jpg" alt="DMA team member" />
      ...
      <div className="memb col-lg-4 py-3">
        <img className="rounded-circle img-fluid " src="./image/Team/Daniyal.jpeg" alt="DMA team member" />
