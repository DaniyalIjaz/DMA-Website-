...
const FeaturedProject5 = () => {
  ...
  const images = [
    "/image/ProjectsDetails/p5/1.jpg",
    "/image/ProjectsDetails/p5/2.jpg",
    "/image/ProjectsDetails/p5/3.jpg",
    "/image/ProjectsDetails/p5/4.jpg",
    "/image/ProjectsDetails/p5/5.jpg",
    "/image/ProjectsDetails/p5/6.jpg"
  ];
  ...
  return (
    ...
    <div className="featuredProject1-container ">
      {/* heading  */}
      <p className='text-center h1 my-4 fw-bold'>NRC Hospital</p>
      {/* Main Image */}
    ...
    <tr>
        <th>Title</th>
        <td>DESIGN OF PROPOSED REHABILITATIONS & UPGRADATIONS OF EXISTING BUILDING FOR NRC HOSPITAL AT RENALA KHURD ROAD, OKARA</td>
      </tr>
      <tr>
        <th>Location</th>
        <td>RENALA KHURD ROAD, OKARA</td>
      </tr>
      <tr>
        <th>Client</th>
        <td>Dr. Zaki</td>
